...
- **[Stm32AdcPot](Stm32AdcPot/)** — STM32F411 (BlackPill, STM32Cube HAL) potentiometer ADC. Compares the manually computed voltage against the VREFINT-calibrated reading and tabulates the error per sample — all-integer math, no FPU dependency in the format path.
